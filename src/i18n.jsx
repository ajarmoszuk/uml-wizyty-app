...
export const T = {
  pl: {
    ...
    // booking rules panel
    rulesTitle: 'Przed umawianiem wizyty',
    rulesToggle: 'Zasady rezerwacji',
    rule1: 'Umówienie na wizytę dotyczy wyłącznie jednej sprawy.',
    rule2: 'Na wizyty umawiamy się na minimalnie na dzień do przodu.',
    rule3: 'Nie ma możliwości kolejnego umówienia się na wizytę w ramach tej samej usługi w tym samym dniu.',
    rule4: 'Prosimy przybyć do budynku nie wcześniej niż 20 minut przed umówioną wizytą. Spóźnienie powoduje, że wizyta przepada.',
    rule5: 'Zrezygnować z wizyty można samodzielnie poprzez link w e-mailu lub dzwoniąc: +48 (42) 638-44-44.',
    rule6: 'Informacja dotycząca ochrony danych osobowych',
...
Ten projekt to nieoficjalny, open-source wrapper — rozmawia z tymi samymi serwerami uml.lodz.pl, ale prezentuje informacje tak, jakby napisał go człowiek. Nic tutaj nie jest zbierane ani przechowywane. Twoje dane trafiają wyłącznie do serwera urzędu.`,
  ...
  en: {
    ...
    // booking rules panel
    rulesTitle: 'Before booking',
    rulesToggle: 'Booking rules',
    rule1: 'Each appointment covers one matter only.',
    rule2: 'Appointments must be booked at least one day in advance.',
    rule3: 'You cannot book another appointment for the same service on the same day.',
    rule4: 'Please arrive no earlier than 20 minutes before your appointment. Late arrival means the appointment is forfeited.',
    rule5: 'To cancel, use the link in the confirmation email or call: +48 (42) 638-44-44.',
    rule6: 'Personal data protection information',
...
This project is an unofficial, open-source wrapper that talks to the same city servers but presents the information like a human being wrote it.`,
  ...
  uk: {
    ...
    // booking rules panel
    rulesTitle: 'Перед записом',
    rulesToggle: 'Правила запису',
    rule1: 'Один запис — одна справа.',
    rule2: 'Запис можливий щонайменше за один день наперед.',
    rule3: 'Не можна записатися ще раз на ту саму послугу в той самий день.',
    rule4: 'Просимо приходити не раніше ніж за 20 хвилин до призначеного часу. Запізнення означає, що запис скасовується.',
    rule5: 'Відмовитися можна за посиланням у листі або зателефонувавши: +48 (42) 638-44-44.',
